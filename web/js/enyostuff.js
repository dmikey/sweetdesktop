...
enyo.kind({
    ...
    update: function (e) {
        var t = !1,
            n = this.positionToPageInfo(e),
            r = n.pos + this.scrollerHeight / 2,
            i = Math.floor(r / Math.max(n.height, this.scrollerHeight) + .5) + n.no,
            s = i % 2 === 0 ? i : i - 1;
    ...
    updateRowBoundsAtIndex: function (e, t, n) {
        var r = n.hasNode().querySelector('div[data-enyo-index="' + e + '"]'),
            i = enyo.dom.getBounds(r);
    ...
    getPageHeight: function (e) {
        ...
        if (!t) {
            var n = this.rowsPerPage * e,
                r = Math.min(this.count - n, this.rowsPerPage);
    ...
    scrollToRow: function (e) {
        var t = this.pageForRow(e),
            n = e % this.rowsPerPage,
            r = this.pageToPosition(t);
    ...
    centerReorderContainerOnPointer: function (e) {
        var t = enyo.dom.calcNodePosition(this.hasNode()),
            n = e.pageX - t.left - parseInt(this.$.reorderContainer.domStyles.width, 10) / 2,
            r = e.pageY - t.top + this.getScrollTop() - parseInt(this.$.reorderContainer.domStyles.height, 10) / 2;
    ...
    positionReorderNode: function (e) {
        var t = this.$.reorderContainer.getBounds(),
            n = t.left + e.ddx,
            r = t.top + e.ddy;
    ...
    moveReorderedContainerToDroppedPosition: function () {
        var e = this.getRelativeOffset(this.placeholderNode, this.hasNode()),
            t = this.getStrategyKind() == "ScrollStrategy" ? e.top : e.top - this.getScrollTop(),
            n = e.left - this.getScrollLeft();
    ...
    positionReorderedNode: function () {
        if (!this.removedInitialPage) {
            ...
            if (this.currentPageNumber != this.initialPageNumber) {
                var t, n, r = this.pageForPageNumber(this.currentPageNumber),
                    i = this.pageForPageNumber(this.currentPageNumber + 1);
    ...
    updateListIndices: function () {
        ...
        var e = Math.min(this.draggingRowIndex, this.placeholderRowIndex),
            t = Math.max(this.draggingRowIndex, this.placeholderRowIndex),
            n = this.draggingRowIndex - this.placeholderRowIndex > 0 ? 1 : -1,
            r, i, s, o;
        if (n === 1) {
    ...
    getNodeStyle: function (e) {
        ...
        if (!t) return;
        var n = this.getRelativeOffset(t, this.hasNode()),
            r = enyo.dom.getBounds(t);
        return {
            h: r.height,
            w: r.width,
            left: n.left,
    ...
    getRelativeOffset: function (e, t) {
        ...
        if (e !== t && e.parentNode)
            do n.top += e.offsetTop || 0, n.left += e.offsetLeft || 0, e = e.offsetParent; while (e && e !== t);
        return n;
    },
    ...
    createPlaceholderNode: function (e) {
        var t = this.$.placeholder.hasNode().cloneNode(!0),
            n = enyo.dom.getBounds(e);
    ...
    updatePageHeight: function (e) {
        ...
        if (t) {
            var n = this.pageHeights[e],
                r = Math.max(1, t.getBounds().height);
    ...
    getRowIndexFromCoordinate: function (e) {
        ...
        if (t < 0) return -1;
        var n = this.positionToPageInfo(t),
            r = n.no == this.p0 ? this.p0RowBounds : this.p1RowBounds;
        if (!r) return this.count;
        var i = n.pos,
            s = this.placeholderNode ? enyo.dom.getBounds(this.placeholderNode).height : 0,
            o = 0;
    ...
    setItemPosition: function (e, t) {
        var n = this.getNodeStyle(t),
            r = this.getStrategyKind() == "ScrollStrategy" ? n.top : n.top - this.getScrollTop(),
            i = "top:" + r + "px; left:" + n.left + "px;";
        e.addStyles(i);
    },
    setItemBounds: function (e, t) {
        var n = this.getNodeStyle(t),
            r = "width:" + n.w + "px; height:" + n.h + "px;";
        e.addStyles(r);
    },
    ...
    swipeDragFinish: function (e, t) {
        if (this.persistentItemVisible) this.dragFinishPersistentItem(t);
        else {
    ...
    positionSwipeableContainer: function (e, t) {
        ...
        if (!n) return;
        var r = this.getRelativeOffset(n, this.hasNode()),
            i = enyo.dom.getBounds(n),
            s = t == 1 ? -1 * i.width : i.width;
    ...
    calcNewDragPosition: function (e) {
        var t = this.$.swipeableComponents.getBounds(),
            n = t.left,
            r = this.$.swipeableComponents.getBounds(),
            i = this.swipeDirection == 1 ? 0 : -1 * r.width,
            s = this.swipeDirection == 1 ? n + e > i ? i : n + e : n + e < i ? i : n + e;
        return s;
    },
    ...
    dragPersistentItem: function (e) {
        var t = 0,
            n = this.persistentItemOrigin == "right" ? Math.max(t, t + e.dx) : Math.min(t, t + e.dx);
        this.$.swipeableComponents.applyStyle("left", n + "px");
    },
    dragFinishPersistentItem: function (e) {
        var t = this.calcPercentageDragged(e.dx) > .2,
            n = e.dx > 0 ? "right" : e.dx < 0 ? "left" : null;
    ...
    backOutSwipe: function (e) {
        var t = this.$.swipeableComponents.getBounds(),
            n = this.swipeDirection == 1 ? -1 * t.width : t.width;
    ...
    slideAwayItem: function () {
        var e = this.$.swipeableComponents,
            t = e.getBounds().width,
            n = this.persistentItemOrigin == "left" ? -1 * t : t;
    ...
    animateSwipe: function (e, t) {
        var n = enyo.now(),
            r = 0,
            i = this.$.swipeableComponents,
            s = parseInt(i.domStyles.left, 10),
            o = e - s;
...
enyo.kind({
    ...
    scroll: function (e, t) {
        ...
        var r = this.getStrategy().$.scrollMath || this.getStrategy(),
            i = -1 * this.getScrollTop();
...
enyo.kind({
    ...
    positionPage: function (e, t) {
        t.pageNo = e;
        var n = this.pageToPosition(e),
            r = this.bottomUp ? this.belowHeight : this.aboveHeight;
...
enyo.kind({
    ...
    start: function () {
        var e = this.container.fromIndex,
            t = this.container.toIndex,
            n = this.container.transitionPoints = [e];
    ...
    flowArrangement: function () {
        ...
        if (e)
            for (var t = 0, n = this.container.getPanels(), r; r = n[t]; t++) this.flowControl(r, e[t]);
    },
...
enyo.kind({
    ...
    size: function () {
        var e = this.container.getPanels(),
            t = this.containerPadding = this.container.hasNode() ? enyo.dom.calcPaddingExtents(this.container.node) : {}, n = this.containerBounds,
            r, i, s, o, u;
    ...
    arrangeNoWrap: function (e, t) {
        var n, r, i, s, o = this.container.getPanels(),
            u = this.container.clamp(t),
            a = this.containerBounds.width;
        for (n = u, i = 0; s = o[n]; n++) {
...
enyo.kind({
    ...
    size: function () {
        ...
        for (r = 0; s = e[r]; r++) {
            ...
            for (j = 0; s = e[j]; j++) {
                var a;
                if (r === 0 && this.container.basePanel) a = 0;
                else if (j < r) a = o;
                else {
                    if (r !== j) break;
            ...
            if (j < u) {
                ...
                for (k = r + 1; k < u; k++) {
                    var f = 0;
                    if (l) f = 0;
                    else if (e[r].width + e[k].width - this.overlap > o) f = 0, l = !0;
                    else {
    ...
    arrange: function (e, t) {
        var n, r, i = this.container.getPanels(),
            s = this.container.clamp(t);
        for (n = 0; r = i[n]; n++) {
    ...
    calcArrangementDifference: function (e, t, n, r) {
        var i = this.container.getPanels(),
            s = e < n ? i[n].width : i[e].width;
        return s;
    },
    destroy: function () {
        var e = this.container.getPanels();
...
enyo.kind({
    ...
    size: function () {
        var e = this.container.getPanels(),
            t = this.containerBounds[this.axisSize],
            n = t - this.margin - this.margin;
    ...
    arrange: function (e, t) {
        ...
        var o = Math.floor(this.container.getPanels().length / 2),
            u = this.getOrderedControls(Math.floor(t) - o),
    ...
    size: function () {
        var e = this.container.getPanels(),
            ...
            n = this.controlWidth = t.width / 3,
            r = this.controlHeight = t.height / 3;
    ...
    arrange: function (e, t) {
        ...
        for (var r = 0, i = e.length, s; s = e[r]; r++) {
            var o = Math.cos(r / i * 2 * Math.PI) * r * n + this.controlWidth,
                u = Math.sin(r / i * 2 * Math.PI) * r * n + this.controlHeight;
            this.arrangeControl(s, {
                left: o,
                top: u
            });
    ...
    arrange: function (e, t) {
        var n = this.colWidth,
            r = this.colHeight,
            i = Math.max(1, Math.floor(this.containerBounds.width / n)),
            s;
        for (var o = 0, u = 0; u < e.length; o++)
            for (var a = 0; a < i && (s = e[u]); a++, u++) this.arrangeControl(s, {
                left: n * a,
                top: r * o
            });
    },
...
enyo.kind({
    ...
    dragTransition: function (e) {
        var t = this.layout ? this.layout.calcDrag(e) : 0,
            ...
            r = n[0],
            i = n[n.length - 1],
            s = this.fetchArrangement(r),
            o = this.fetchArrangement(i),
            u = this.layout ? this.layout.drag(t, r, s, i, o) : 0,
            a = t && !u;
        a, this.fraction += u;
        var f = this.fraction;
    ...
    verifyDragTransition: function (e) {
        var t = this.layout ? this.layout.calcDragDirection(e) : 0,
            ...
            r = Math.max(this.fromIndex, this.toIndex);
        if (t > 0) {
            var i = n;
            n = r, r = i;
        }
    ...
    statics: {
        ...
        lerpObject: function (e, t, n) {
            var r = enyo.clone(e),
                i, s;
            if (t)
                for (var o in e) i = e[o], s = t[o], i != s && (r[o] = i - (i - s) * n);
            return r;
        }
    }
});
...
enyo.kind({
    ...
    expandedChanged: function (e) {
        if (!this.expandable) this.expanded = !1;
        else {
            var t = {
...
enyo.kind({
    ...
    positionClientControls: function () {
        ...
        for (var t = 0; t < e.length; t++)
            for (var n in this.position) e[t].applyStyle(n, this.position[n] + "px");
    },
    ...
    reAnchor: function (e, t) {
        var n = t.scale,
            r = t.bounds,
            i = this.anchor.right ? this.anchor.rightCoords.units == "px" ? r.width + r.x - this.anchor.rightCoords.value * n : r.width * (100 - this.anchor.rightCoords.value) / 100 + r.x : this.anchor.leftCoords.units == "px" ? this.anchor.leftCoords.value * n + r.x : r.width * this.anchor.leftCoords.value / 100 + r.x,
            s = this.anchor.bottom ? this.anchor.bottomCoords.units == "px" ? r.height + r.y - this.anchor.bottomCoords.value * n : r.height * (100 - this.anchor.bottomCoords.value) / 100 + r.y : this.anchor.topCoords.units == "px" ? this.anchor.topCoords.value * n + r.y : r.height * this.anchor.topCoords.value / 100 + r.y;
...
enyo.kind({
    ...
    dragPropagation: function (e, t) {
        var n = this.getStrategy().getScrollBounds(),
            r = n.top === 0 && t.dy > 0 || n.top >= n.maxTop - 2 && t.dy < 0,
            i = n.left === 0 && t.dx > 0 || n.left >= n.maxLeft - 2 && t.dx < 0;
    ...
    mousewheel: function (e, t) {
        ...
        var n = (this.maxScale - this.minScale) / 10,
            r = this.scale;
        if (t.wheelDelta > 0 || t.detail < 0) this.scale = this.limitScale(this.scale + n);
        else if (t.wheelDelta < 0 || t.detail > 0) this.scale = this.limitScale(this.scale - n);
    ...
    scaleChanged: function () {
        ...
        if (e) {
            ...
            var t = this.containerWidth / this.originalWidth,
                n = this.containerHeight / this.originalHeight;
...
enyo.kind({
    ...
    getPageOffset: function (e) {
        var t = e.getBoundingClientRect(),
            n = window.pageYOffset === undefined ? document.documentElement.scrollTop : window.pageYOffset,
            r = window.pageXOffset === undefined ? document.documentElement.scrollLeft : window.pageXOffset,
            i = t.height === undefined ? t.bottom - t.top : t.height,
            s = t.width === undefined ? t.right - t.left : t.width;
        return {
            top: t.top + n,
            left: t.left + r,
            height: i,
    ...
    adjustPosition: function () {
        if (this.showing && this.hasNode()) {
            ...
            var e = this.node.getBoundingClientRect(),
                t = e.height === undefined ? e.bottom - e.top : e.height,
                n = window.innerHeight === undefined ? document.documentElement.clientHeight : window.innerHeight,
                r = window.innerWidth === undefined ? document.documentElement.clientWidth : window.innerWidth;
...
enyo.kind({
    ...
    initDefaults: function () {
        ...
        if (!this.is24HrMode) {
            ...
            for (r = 0; r < 24; r++) this.$.hourPicker.createComponent({
                content: r,
                value: r,
                active: r == n.getHours()
            });
...
enyo.kind({
    ...
    hideAtZIndex: function (e) {
        this.removeZIndex(e);
        if (!this.zStack.length) this.hide();
        else {
...
enyo.kind({
    ...
    updateBarPosition: function () {
        if (this.$.startKnob !== undefined && this.$.endKnob !== undefined) {
            var e = this.calcKnobPercent(this.rangeStart),
                t = this.calcKnobPercent(this.rangeEnd) - e;
...
enyo.kind({
    ...
    adjustPosition: function () {
        if (this.showing && this.hasNode()) {
            ...
            var e = this.getViewWidth(),
                t = this.getViewHeight(),
                n = this.vertFlushMargin,
                r = t - this.vertFlushMargin,
                i = this.horizFlushMargin,
                s = e - this.horizFlushMargin;
    ...
    initVerticalPositioning: function () {
        ...
        var e = this.getBoundingRect(this.node),
            t = this.getViewHeight();
    ...
    applyVerticalFlushPositioning: function (e, t) {
        if (!this.initVerticalPositioning()) return !1;
        var n = this.getBoundingRect(this.node),
            r = this.getViewWidth();
    ...
    applyHorizontalPositioning: function () {
        ...
        var e = this.getBoundingRect(this.node),
            t = this.getViewHeight(),
            n = this.activatorOffset.top + this.activatorOffset.height / 2;
...
enyo.g11n.Utils = enyo.g11n.Utils || function () {}, enyo.g11n.Utils._fileCache = {}, enyo.g11n.Utils._getBaseURL = function (e) {
    ...
    var e = window.document,
        t = enyo.g11n.Utils._getBaseURL(e).match(new RegExp(".*://[^#]*/"));
    if (t) return t[0];
    ...
    if (enyo.g11n.Utils._fileCache[i] !== undefined) n = enyo.g11n.Utils._fileCache[i].json;
    else {
    ...
    if (enyo.g11n.Utils._fileCache[l] !== undefined) n = enyo.g11n.Utils._fileCache[l].json;
    else {
...
enyo.g11n.Template = function (e, t) {
    ...
    try {
        var n = this.template ? this.template.split("|") : [],
            r = [],
            i = [],
            s = "",
            o;
...
enyo.g11n.DateFmt = function (e) {
    ...
    s = this, s._normalizedComponents = {
        ...
        var n = t && s.ParserChunks[t] || s.ParserChunks.full,
            r = e.length,
            i = [],
            o, u, a = new RegExp(n, "g");
        while (r > 0) {
    ...
    var n, r, i, s, o, u, a, f, l = this.partsLength || "medium",
        c = this.dateTimeHash,
        h = this.dateTimeFormatHash;
...
enyo.g11n.DurationFmt = function (e) {
    ...
    if (this.style === "long" || this.style === "full")
        for (i = 0; i < this.timeParts.length; i++) s = e[this.timeParts[i]] || 0, s > 0 && (o = this.parts[this.timeParts[i]].formatChoice(s, {
            num: s
...
enyo.g11n.NamePriv = {
    _findPrefix: function (t, n, r) {
        var i, s, o, u = [],
            a;
        if (t.length > 0 && n)
            for (a = t.length; a > 0; a--) o = t.slice(0, a), i = o.join(r ? "" : " "), s = i.toLowerCase(), s = s.replace(/[,\.]/g, ""), s in n && (u = u.concat(r ? i : o), t = t.slice(a), a = t.length + 1);
        return u;
    },
    _isEuroName: function (t) {
        ...
        for (r = 0; r < t.length; r++) {
            n = t.charAt(r);
            if (!enyo.g11n.Char.isIdeo(n) && !enyo.g11n.Char.isPunct(n) && !enyo.g11n.Char.isSpace(n)) return !0;
        }
        return !1;
    },
    _findLastConjunction: function (t, n) {
        ...
        for (i = 0; i < t.length; i++) {
            s = t[i];
            if (typeof s == "string") {
                if ("and" === s.toLowerCase() || "or" === s.toLowerCase() || "&" === s || "+" === s) r = i;
                if (o.$L({
                    key: "and1",
                    value: "and"
                    ...
                    key: "or2",
                    value: "or"
                }).toLowerCase() === s.toLowerCase() || "&" === s || "+" === s) r = i;
            }
        }
        return r;
    },
    _joinArrayOrString: function (t) {
        var n;
        if (typeof t == "object") {
            for (n = 0; n < t.length; n++) t[n] = enyo.g11n.NamePriv._joinArrayOrString(t[n]);
            return t.join(" ");
        }
        return t;
    },
    _shallowCopy: function (t, n) {
        var r;
        for (r in t) r !== undefined && t[r] && (n[r] = t[r]);
    }
    ...
    if (typeof e == "object") return this.prefix = e.prefix, this.givenName = e.givenName, this.middleName = e.middleName, this.familyName = e.familyName, this.suffix = e.suffix, this;
    ...
    if (!r || !r.name || r.name.isAsianLocale && enyo.g11n.NamePriv._isEuroName(e)) r = s;
    ...
    if (o.length > 1)
        for (u = o.length; u > 0; u--) {
            ...
            if (i.titles && enyo.indexOf(l, i.titles) > -1 || i.honorifics && enyo.indexOf(l, i.honorifics) > -1) this.prefix ? (d || (this.prefix += " "), this.prefix += f) : this.prefix = f, o = o.slice(u), u = o.length;
        }
    if (o.length > 1)
        for (u = o.length; u > 0; u--) c = o.slice(-u), h = c.join(d ? "" : " "), p = h.toLowerCase(), p = p.replace(/[,\.]/g, ""), i.suffixes && enyo.indexOf(p, i.suffixes) > -1 && (this.suffix ? (d || (this.suffix = " " + this.suffix), this.suffix = h + this.suffix) : this.suffix = h, o = o.slice(0, o.length - u), u = o.length);
    ...
    _joinNameArrays: function () {
        var t;
        for (t in this) this[t] !== undefined && typeof this[t] == "object" && this[t] instanceof Array && (this[t] = enyo.g11n.NamePriv._joinArrayOrString(this[t]));
    },
    _adjoinAuxillaries: function (e, t) {
        var n, r, i, s, o;
        if (t.auxillaries && (e.length > 2 || this.prefix))
            for (n = 0; n < e.length - 1; n++)
                for (r = e.length; r > n; r--) i = e.slice(n, r), s = i.join(" "), o = s.toLowerCase(), o = o.replace(/[,\.]/g, ""), o in t.auxillaries && (e.splice(n, r + 1 - n, i.concat(e[r])), r = n);
        return e;
    },
    getSortName: function (e) {
        var t, n, r, i, s, o, u, a;
        if (!this.familyName) return undefined;
        ...
        if (o)
            ...
            n = "";
            for (a = 0; a < f.length; a++) n += o.knownFamilyNames[f[a]] || "";
        }
...
enyo.g11n.Name.shortName = "short", enyo.g11n.Name.mediumName = "medium", enyo.g11n.Name.longName = "long", enyo.g11n.NameFmt = function (e) {
    ...
    if (!this.langInfo || !this.langInfo.name) this.langInfo = enyo.g11n.Utils.getJsonFile({
        root: enyo.g11n.Utils._getEnyoRoot(),
        path: "name/data",
        locale: new enyo.g11n.Locale("en")
    });
...
enyo.g11n.PhoneUtils = {
    ...
    deepCopy: function e(t, n) {
        var r;
        for (r in t) r && (typeof t[r] == "object" ? (n[r] = {}, e(t[r], n[r])) : n[r] = t[r]);
        return n;
    },
...
enyo.g11n.FmtStyles = function (e) {
    ...
    getExamples: function () {
        ...
        t = [];
        if (this.styles)
            for (n in this.styles) this.styles[n].example && t.push({
                key: n,
...
enyo.g11n.PhoneFmt = function (e) {
    ...
    _substituteDigits: function (t, n, r) {
        ...
        if (!t) return s;
        if (typeof n == "object") {
            if (t.length > n.length) throw "part " + t + " is too big. We do not have a format template to format it.";
            i = n[t.length - 1];
        } else i = n;
        for (u = 0; u < i.length; u++) i.charAt(u) === "X" ? (s += t.charAt(o), o++) : s += i.charAt(u);
        if (r && o < t.length - 1) throw "too many digits in " + t + " for format " + i;
        return s;
    },
    format: function (t, n) {
        var r, i, s, o, u, a, f, l = "",
        ...
        try {
            ...
            l = "";
            for (f in enyo.g11n.PhoneUtils.fieldOrder) typeof f == "string" && typeof enyo.g11n.PhoneUtils.fieldOrder[f] == "string" && t[enyo.g11n.PhoneUtils.fieldOrder[f]] !== undefined && (l += t[enyo.g11n.PhoneUtils.fieldOrder[f]], enyo.g11n.PhoneUtils.fieldOrder[f] === "countryCode" && (l += " "));
        }
    ...
    reformat: function (e, t) {
        ...
        for (r = 0; r < e.length; r++) i = e.charAt(r), enyo.g11n.PhoneUtils._getCharacterCode(i) > -1 ? s++ : enyo.indexOf(i, p) > -1 ? o++ : u++;
        if (this.plan && this.plan.fieldLengths && this.plan.fieldLengths.minLocalLength && s < this.plan.fieldLengths.minLocalLength && u > 0) return e;
        if (s < u) return e;
...
enyo.g11n.StateHandler = function () {
    ...
    if (typeof t.contextFree == "boolean" && t.contextFree === !1) return new enyo.g11n.CSStateHandler;
    var n = e && e.region || "zz";
    switch (n) {
    case "us":
...
enyo.g11n.PhoneNumber = function (e, t) {
    ...
    if (!e || typeof e == "string" && e.length === 0) return this;
    if (typeof e == "object") return enyo.g11n.PhoneUtils.deepCopy(e, this), this;
    ...
    while (n < e.length) r = enyo.g11n.PhoneUtils._getCharacterCode(e.charAt(n)), r >= 0 ? (s = u.get(i)[r], s === -1 && u.get(i)[c] !== -1 && (s = u.get(i)[c]), s < 0 ? (s = -s - 1, a = enyo.g11n.PhoneUtils.states[s], e.charAt(0) === "^" ? f = o.handler[a](e.slice(1), n - 1, this, o) : f = o.handler[a](e, n, this, o), e = f.number, n = 0, i = 0, f.push !== undefined ? (h = f.push, l = new enyo.g11n.StatesData({
        root: enyo.g11n.Utils._getEnyoRoot("../"),
        path: "phone/parse/data",
        locale: h
    ...
    _stripFormatting: function (t) {
        var n = "",
            r;
        for (r = 0; r < t.length; r++) enyo.g11n.PhoneUtils._getCharacterCode(t.charAt(r)) >= -1 && (n += t.charAt(r));
        return n;
    },
    _getPrefix: function () {
    ...
    _join: function () {
        var e, t, n = "";
        try {
            for (e in enyo.g11n.PhoneUtils.fieldOrder) typeof e == "string" && typeof enyo.g11n.PhoneUtils.fieldOrder[e] == "string" && (t = enyo.g11n.PhoneUtils.fieldOrder[e], this[t] !== undefined && (n += this[t]));
        } catch (r) {
    ...
    compare: function (e) {
        ...
        if (!this.subscriberNumber || !e.subscriberNumber || this.subscriberNumber !== e.subscriberNumber) return 0;
        if (this._xor(this.extension, e.extension) || this.extension !== e.extension) return 0;
        if (this._xor(this.countryCode, e.countryCode)) switch (this.locale.region) {
        case "fr":
            if (this.countryCode in n || e.countryCode in n) {
                if (this.areaCode !== e.areaCode || this.mobilePrefix !== e.mobilePrefix) t -= 100;
            } else t -= 16;
            break;
        case "it":
        ...
        default:
            t -= 16;
            if (this.countryCode !== undefined && this.countryCode !== o || e.countryCode !== undefined && e.countryCode !== o) t -= 16;
        } else if (this.countryCode !== e.countryCode)
            if (e.countryCode === "33" || this.countryCode === "33")
                if (this.countryCode in n || e.countryCode in n) {
                    if (this.areaCode !== e.areaCode || this.mobilePrefix !== e.mobilePrefix) t -= 100;
                } else t -= 100;
                else this.countryCode === "39" || e.countryCode === "39" ? this.countryCode in r || e.countryCode in r ? this.areaCode !== e.areaCode && (t -= 100) : t -= 100 : t -= 100;
    ...
    equals: function (t) {
        var n;
        if (t.locale && this.locale && !this.locale.equals(t.locale) && (!this.countryCode || !t.countryCode)) return !1;
        for (n in t)
            if (n !== undefined && this[n] !== undefined && typeof this[n] != "object") {
                if (t[n] === undefined) return enyo.error("PhoneNumber.equals: other is missing property " + n + " which has the value " + this[n] + " in this"), enyo.error("this is : " + JSON.stringify(this)), enyo.error("other is: " + JSON.stringify(t)), !1;
                if (this[n] !== t[n]) return enyo.error("PhoneNumber.equals: difference in property " + n), enyo.error("this is : " + JSON.stringify(this)), enyo.error("other is: " + JSON.stringify(t)), !1;
            }
        for (n in t)
            if (n !== undefined && t[n] !== undefined && typeof t[n] != "object") {
                if (this[n] === undefined) return enyo.error("PhoneNumber.equals: this is missing property " + n + " which has the value " + t[n] + " in the other"), enyo.error("this is : " + JSON.stringify(this)), enyo.error("other is: " + JSON.stringify(t)), !1;
                if (this[n] !== t[n]) return enyo.error("PhoneNumber.equals: difference in property " + n), enyo.error("this is : " + JSON.stringify(this)), enyo.error("other is: " + JSON.stringify(t)), !1;
            }
        return !0;
    },
    normalize: function (e) {
        ...
        if (!o.invalid && e && e.assistedDialing) {
            if (o.subscriberNumber && (!e.manualDialing || o.iddPrefix || o.countryCode || o.trunkAccess))
                ...
                if (e.sms && f.region === "us" && l.region !== "us") o.iddPrefix = "011", n.skipTrunk && o.trunkAccess && delete o.trunkAccess;
                else if (o.iddPrefix || o.countryCode) delete o.iddPrefix, delete o.countryCode, (n.dialingPlan === "open" || n.trunkRequired) && n.trunkCode && (o.trunkAccess = n.trunkCode);
            }
        } else o.invalid || (!o._hasPrefix() && e && e.defaultAreaCode && c.region === f.region && (o.areaCode = e.defaultAreaCode), !o.countryCode && o._hasPrefix() && (o.countryCode = enyo.g11n.PhoneUtils.mapRegiontoCC(c.region)), o.countryCode && (e && e.networkType && e.networkType === "cdma" ? o.iddPrefix = t.iddCode : o.iddPrefix = "+", n.skipTrunk && o.trunkAccess ? delete o.trunkAccess : !n.skipTrunk && !o.trunkAccess && n.trunkCode && (o.trunkAccess = n.trunkCode)));
    ...
    _parseAreaAndSubscriber: function (t, n) {
        ...
        while (i < t.length) {
            ...
            if (r >= 0) {
                ...
                if (u < 0) return o = u, u = -u - 1, s = enyo.g11n.PhoneUtils.states[u], s === "area" ? a : undefined;
                o = u, i++;
            } else r === -1 ? i++ : i++;
        }
        return undefined;
    ...
    _matchPrefix: function (t, n) {
        ...
        for (o in n)
            if (o && typeof o == "string") {
                r = 0, i = !1;
                while (r < o.length && (o.charAt(r) === t.charAt(r) || o.charAt(r) === ".")) o.charAt(r) === "." && (i = !0), r++;
                if (r >= o.length) {
                    if (!i) return n[o];
                    s.push(o);
                }
        ...
        if (e !== undefined && typeof e == "object" && e instanceof enyo.g11n.PhoneNumber) {
            ...
            if (c !== undefined)
                if (f.extendedAreaCodes) {
                    ...
                    if (!f.fieldLengths || f.fieldLengths.maxLocalLength === undefined || !e.subscriberNumber || e.subscriberNumber.length <= f.fieldLengths.maxLocalLength) s = this._matchPrefix(c, a), s && s.sn && s.ln && (t.area = {
                        sn: s.sn,
                        ln: s.ln
                    });
                } else !f || !f.fieldLengths || f.fieldLengths.maxLocalLength === undefined || !e.subscriberNumber || e.subscriberNumber.length <= f.fieldLengths.maxLocalLength ? a && (u = c.replace(/[wWpPtT\+#\*]/g, ""), s = this._matchPrefix(u, a), s && s.sn && s.ln ? t.area = {
                sn: s.sn,
                ln: s.ln
...
enyo.kind({
    ...
    arrangerSelected: function (e, t) {
        var n = this.$.samplePanels,
            r = this.panelArrangers[t.originator.indexInContainer() - 1];
...
function makeName(e, t, n, r) {
    n = n || "", r = r || "";
    var i = "aeiouyhaeiouaeiou",
        s = "bcdfghjklmnpqrstvwxzbcdfgjklmnprstvwbcdfgjklmnprst",
        o = i + s,
        u = rnd(e, t) - n.length - r.length;
    u < 1 && (u = 1);
    var a = 0,
        f;
    if (n.length > 0)
        for (f = 0; f < n.length; f++) a == 2 && (a = 0), s.indexOf(n[f]) != -1 && a++;
    else a = 1;
    var l = n;
    for (f = 0; f < u; f++) a == 2 ? (touse = i, a = 0) : touse = o, c = touse.charAt(rnd(0, touse.length - 1)), l += c, s.indexOf(c) != -1 && a++;
...
enyo.kind({
    ...
    setupItem: function (e, t) {
        var n = t.index,
            r = this.filter ? this.filtered : this.db,
            i = r[n];
    ...
    addItem: function () {
        var e = this.generateItem(enyo.cap(this.$.newContactInput.getValue())),
            t = 0;
...
var avatars = ["angel.png", "astrologer.png", "athlete.png", "baby.png", "clown.png", "devil.png", "doctor.png", "dude.png", "dude2.png", "dude3.png", "dude4.png", "dude5.png", "dude6.png"],
    titles = ["Regional Data Producer", "Internal Markets Administrator", "Central Solutions Producer", "Dynamic Program Executive", "Direct Configuration Executive", "International Marketing Assistant", "District Research Consultant", "Lead Intranet Coordinator", "Central Accountability Director", "Product Web Assistant"];
...
enyo.kind({
    ...
    removeSelected: function () {
        ...
        for (var t = 0; t < e.length; t++) this._removeItem(e[t]);
...
enyo.kind({
    ...
    getRelativeDateString: function (e) {
        ...
        if (n.toLocaleDateString() == t.toLocaleDateString()) {
            var i = n.getHours() - t.getHours(),
                s = n.getMinutes() - t.getMinutes();
...
enyo.kind({
    ...
    setupItem: function (e, t) {
        ...
        var r = this.data[n].langs[this.data[n].currentIndex],
            i = this.data[n].val,
            s = this.languages[r][i],
            o = this.data[n].serial;
    ...
    createRandomData: function () {
        var e = this.getLanguages(),
            t, n = parseInt(this.$.numRows.getValue(), 10);
        this.data = [];
        var r = function () {
            return .5 - Math.random();
        };
        for (var i = 0; i < n; i++) t = enyo.clone(e), t.sort(r), this.data.push({
            langs: t,
            val: i % 10,
            currentIndex: 0,
            serial: i
...
enyo.kind({
    ...
    getRandomIndex: function () {
        ...
        while (e == this.$.carousel.index) e = Math.floor(Math.random() * this.$.carousel.images.length);
        return e;
    },
...
enyo.kind({
    ...
    changeValue: function (e, t) {
        for (var n in this.$)
            if (this.$[n].kind == "onyx.ProgressBar" || this.$[n].kind == "onyx.ProgressButton") this.$.animateSetting.getValue() ? this.$[n].animateProgressTo(this.$.input.getValue()) : this.$[n].setProgress(this.$.input.getValue());
    },
    incValue: function () {
    ...
    incrementProgress: function () {
        var e = this.$.progressSlider,
            t = e.min + (e.progress - e.min + 5) % (e.max - e.min + 1);
...
enyo.kind({
    ...
    create: function () {
        ...
        var e = ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"],
            t = new Date,
            n, r;
        for (n = 0; r = e[n]; n++) this.$.monthPicker.createComponent({
            content: r,
            active: n == t.getMonth()
        });
        for (n = 0; n < 30; n++) this.$.dayPicker.createComponent({
            content: n + 1,
...
enyo.kind({
    ...
    renderChildren: function (e) {
        ...
        if (t)
            for (var r = 0, i; i = this.children[r]; r++) i.render(t);
    },
    update: function () {
        var e = this.hasNode();
        if (e.getContext) {
...
enyo.kind({
    ...
    setupBalls: function () {
        ...
        var e = ["green", "blue", "black", "brown", "red", "orange"],
            t, n, r, i;
    ...
    reset: function () {
        var e = this.$.balls.hasNode(),
            t = e ? parseInt(e.value, 0) : this.balls;
        if (isFinite(t) && t >= 0 && t != this.balls) this.setBalls(t);
        else
            for (var n = 0, r; r = this.$.ballpit.children[n]; n++) r.bounds.t = enyo.irand(375), r.vel = 0;
    },
...
enyo.kind({
    ...
    handleEvent: function (e, t) {
        var n = enyo.clone(t);
        if (this.monitorEvent && n.type != this.monitorEvent) return !0;
    ...
    truncateChanged: function () {
        for (var e in this.eventList) this.eventList[e].setTruncate(this.$.truncateDetail.getValue());
    ...
    removeAllEvents: function () {
        for (var e in this.eventList) this.eventList[e].destroy(), delete this.eventList[e];
    ...
    getPropsString: function () {
        var e = [];
        for (var t in this.event) this.event[t] !== undefined && this.event[t] !== null && !(this.event[t] instanceof Object) && t != "type" && e.push(t + ": " + this.event[t]);
...
enyo.kind({
    ...
    inputChanged: function (e, t) {
        var n = new enyo.g11n.GeoLocator,
            r = new enyo.g11n.PhoneNumber(e.getValue()),
            i = new enyo.g11n.PhoneFmt;
        try {
